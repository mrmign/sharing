...
from handlers.extension import ( UserDataHandler, 
                                UserGroupsHandler, 
                                ExtensionAddLinkHandler,
                                )
url_patterns = [
    (r"/", HomeHandler),
    ...
    (r"/extension/account", UserDataHandler),
    (r"/extension/groups", UserGroupsHandler),
    (r"/extension/new", ExtensionAddLinkHandler),
]
